...
try:
    from gensim.models.doc2vec_btf import train_document_dbow, train_document_dm, train_document_dm_concat
...
class Doc2Vec_btf(Word2Vec):
    ...
    def __init__(self, documents=None, size=300, alpha=0.025, window=8, min_count=5,
        ...
        """
        super(Doc2Vec_btf, self).__init__(
    ...
    def clear_sims(self):
        super(Doc2Vec_btf, self).clear_sims()
    ...
    def reset_weights(self):
        ...
        super(Doc2Vec_btf, self).reset_weights()
    ...
    def reset_from(self, other_model):
        ...
        super(Doc2Vec_btf, self).reset_from(other_model)
...
##            print "=======batas doc========="
    ...
    def estimate_memory(self, vocab_size=None, report=None):
        ...
        return super(Doc2Vec_btf, self).estimate_memory(vocab_size, report=report)
