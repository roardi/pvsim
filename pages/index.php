        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1" style="margin-top:-200px;">
                <div class="login-panel panel panel-default">
					...
					<ul class="nav navbar-top-links navbar-right" ><font size="3px"><i>Metode PVW-A</i></font></ul> 
                    </div>
					...
					if(isset($_POST['search'])){
						...
						if ($q != ""){
							...
							$command = print_r(shell_exec("pvsim_atf.py $q"),true);
						...
						?>
								<div class="chat-body clearfix">
									...
									<span class="pull-right">
										<i><?php //echo $data[$i]['similarity']."<progress value=".$data[$i]['similarity']." max='100'></progress>";?></i><br><br>
									</span>
								</div>
						<?php
								}
